...
#define CAN_GPIO_BASE_ADDR   0x60080008
#define CAN_GPIO_BASE_ADDR2  0x60080000
#define CAN_GPIO_BASE_ADDR3 ((uint32_t *)0x60080008)
...
struct can_regs2{
    volatile uint8_t can1_rxd;
    volatile uint8_t can1_sts;
    volatile uint8_t can2_rxd;
    volatile uint8_t can2_sts;
...
struct can_regs
{
    volatile uint32_t can1_cmd :8;
    volatile uint32_t can1_txd :8;
    volatile uint32_t can2_cmd :8;
    volatile uint32_t can2_txd :8;
};


struct can_regs3
{
    volatile uint32_t can1_cmd2 ;
    volatile uint32_t can1_cmd3 ;
};



extern void data_txd1(void);
extern void data_rxd2(void);
extern void can_init(void);
extern void write_register1(uint8_t reg_addr, uint8_t reg_data);
extern void write_register2(uint8_t reg_addr, uint8_t reg_data);
extern uint8_t read_register1(uint8_t reg_addr);
extern uint8_t read_register2(uint8_t reg_addr);
